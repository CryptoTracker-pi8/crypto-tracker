...
/favorites — список избранных валют (и управление)
/alert — управление уведомлениями по изменению цены
...
• <code>/favorites</code> — список/управление избранным
• <code>/alert</code> — создать/посмотреть/удалить алерты
• <code>/settings</code> — настройки режима уведомлений
...
async def cmd_status(message: Message):
    ...
    await message.answer(f"⏳ Подтягиваем {symbol} цену...", reply_markup=main_kb())
